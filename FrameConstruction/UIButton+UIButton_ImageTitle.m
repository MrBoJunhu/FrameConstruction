//
//  UIButton+UIButton_ImageTitle.m
//  LaiApp_OC
//
//  Created by BillBo on 2017/4/7.
...
@implementation UIButton (UIButton_ImageTitle)

- (void)layoutButtonWithEdgeInsetsStyle:(BBButtonEdgeInsetsStyle)style imageTitleSpace:(CGFloat)space {
